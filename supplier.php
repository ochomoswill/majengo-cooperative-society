                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i>Construction <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    ...
                                    <li><a href="client.html">Client Details</a>
                                    </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="images/img.jpg" alt="">Ochomo William
                                ...
                                <form method = "POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <input type="number" name = "supplierid" id="supplier-id" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name = "suppliername" id="supplier-name" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mtrl-supplied">Material Supplied <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name = "mtrlsupplied" id="mtrl-supplied"  required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="qnty-supplied" class="control-label col-md-3 col-sm-3 col-xs-12">Quantity Supplied<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="qnty-supplied" class="form-control col-md-7 col-xs-12" type="number" name="qntysupplied">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mtrl-cost">Cost of Material <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="mtrlcost" id="mtrl-cost" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Date Supplied <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type= "date" name= "datesupplied" id="date-supplied"  required="required" type="text">
                                        </div>
                                    </div>
...
if(isset($_POST['ok']))
{
    ...
    $mtrlsupplied = $_POST['mtrlsupplied'];
    $qntysupplied = $_POST['qntysupplied'];
    $mtrlcost = $_POST['mtrlcost'];
    $phone = $_POST['phone'];
    $email = $_POST['email'];
    $datesupplied = $_POST['datesupplied'];

    mysqli_query($connect,"INSERT INTO tblsupplier(supplierid,suppliername,mtrlsupplied,qntysupplied,mtrlcost,phone,email,datesupplied)VALUES('$supplierid','$suppliername','$mtrlsupplied','$qntysupplied','$mtrlcost','$phone','$email','$datesupplied')");
